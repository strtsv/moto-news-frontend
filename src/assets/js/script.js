	...
	$(function () {
		...
		function transformView(element) {
			...
			if (window.scrollY > (elementTop + window.scrollY) // target not below
				...
				let visiblePartRatio = (1 - (elementHeight - Math.abs(elementTop)) / elementHeight).toFixed(2);

				// Effect parameters
				let scaleDiff = 0.2, // difference between initial parallaxImage scale and resulting
